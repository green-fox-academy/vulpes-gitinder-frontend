...
public class MockPicassoWIP extends Picasso{
    ...
    MockPicassoWIP(Context context, Dispatcher dispatcher, Cache cache, Listener listener, RequestTransformer requestTransformer, List<RequestHandler> extraRequestHandlers, Stats stats, Bitmap.Config defaultBitmapConfig, boolean indicatorsEnabled, boolean loggingEnabled) {
    ...
    public MockPicassoWIP create() {
        return new MockPicassoWIP(context, dispatcher, cache, listener, transformer, NO_HANDLERS,
...
//        assertTrue((picasso.targetToAction).isEmpty());
//        picasso.enqueueAndSubmit(action);
//        assertTrue((picasso.targetToAction).hasSize(1));
