...
class TestUtils {
  ...
  static final String URI_KEY_1 = new Request.Builder(URI_1).build().stableKey;
  static final String URI_KEY_2 = new Request.Builder(URI_2).build().stableKey;
  static final String STABLE_URI_KEY_1 = new Request.Builder(URI_1).stableKey(STABLE_1).build().stableKey;
  static final File FILE_1 = new File("C:\\windows\\system32\\logo.exe");
  static final String FILE_KEY_1 = new Request.Builder(Uri.fromFile(FILE_1)).build().stableKey;
  ...
  static final String MEDIA_STORE_CONTENT_KEY_1 =
      new Request.Builder(MEDIA_STORE_CONTENT_1_URL).build().stableKey;
  static final Uri CONTENT_1_URL = Uri.parse("content://zip/zap/zoop.jpg");
  static final String CONTENT_KEY_1 = new Request.Builder(CONTENT_1_URL).build().stableKey;
  static final Uri CONTACT_URI_1 = CONTENT_URI.buildUpon().appendPath("1234").build();
  static final String CONTACT_KEY_1 = new Request.Builder(CONTACT_URI_1).build().stableKey;
  static final Uri CONTACT_PHOTO_URI_1 =
      CONTENT_URI.buildUpon().appendPath("1234").appendPath(CONTENT_DIRECTORY).build();
  static final String CONTACT_PHOTO_KEY_1 = new Request.Builder(CONTACT_PHOTO_URI_1).build().stableKey;
  static final int RESOURCE_ID_1 = 1;
  static final String RESOURCE_ID_KEY_1 = new Request.Builder(RESOURCE_ID_1).build().stableKey;
  static final Uri ASSET_URI_1 = Uri.parse("file:///android_asset/foo/bar.png");
  static final String ASSET_KEY_1 = new Request.Builder(ASSET_URI_1).build().stableKey;
  ...
  static final Uri RESOURCE_ID_URI = new Uri.Builder().scheme(SCHEME_ANDROID_RESOURCE)
      ...
      .build();
  static final String RESOURCE_ID_URI_KEY = new Request.Builder(RESOURCE_ID_URI).build().stableKey;
  ...
  static final String RESOURCE_TYPE_URI_KEY =
      new Request.Builder(RESOURCE_TYPE_URI).build().stableKey;
  static final Uri CUSTOM_URI = Uri.parse("foo://bar");
  static final String CUSTOM_URI_KEY = new Request.Builder(CUSTOM_URI).build().stableKey;
  ...
  static Action mockAction(Request request, final Object target, String tag) {
    Action action = spy(new Action(mockPicasso(),target , request, 0, 0, 0, null, null, null, false) {
...
//  }
  ...
  static Picasso defaultPicasso(Context context, boolean hasRequestHandlers,
    ...
    if (hasTransformers) {
      builder.requestTransformer(NOOP_TRANSFORMER);
